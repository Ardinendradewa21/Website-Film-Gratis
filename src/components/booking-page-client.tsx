...
export default function BookingPageClient({ id }: BookingPageClientProps) {
    ...
    const handleCheckout = async () => {
        ...
        try {
            ...
            const booking = {
                ...
                theater: 'Cinema XXI Grand Indonesia', // Default theater
                totalPrice: totalPrice,
                status: 'upcoming' as const,
            }

            // Save to Firestore
            await createBooking(user.uid, booking)

            // Clear selection and redirect
            clearSelection()
            router.push('/watchlist?tab=bookings')
        } catch (error) {
